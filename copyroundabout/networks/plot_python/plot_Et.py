...
if all_data:
    ...
    sns.boxplot(data=rl_0_df, x='Model', y='emissions_electricity_abs', order=model_order)
    
    # 调整标签和标题以反映实际内容
    plt.xlabel('Model')
    plt.ylabel('Emissions Electricity Abs (wh)')
    plt.title('Emissions Electricity Boxplot for rl_0 Across Models')
