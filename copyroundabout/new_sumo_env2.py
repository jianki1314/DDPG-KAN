...
class SumoEnv(gym.Env):
    ...
    def __init__(self, render_mode: Optional[str] = None, max_episodes: int = 3, flash_episode: bool = False) -> None:
        ...
        self.max_episodes_failed = False  # 是否达到最大回合数
    ...
    def reset(self, seed: Optional[int] = None):
        ...
        self.terminated = False
        self.truncated = False
        self.max_episodes_failed = False
        self.prev_distance = 0  # 车辆上一步的距离
        self.collision_count = 0 # 碰撞警示累积数
        self.speed_x = 0  # x轴速度
        self.speed_y = 0  # y轴速度
    ...
    def save_csv(self, episode):
        ...
        保存当前回合的仿真数据到CSV文件。
        """
        base_path = "networks/output_data/output_ppo/state"
    ...
    def step(self, action):
        ...
        if self.max_episodes_failed:
            info = {"message": "True"}
        else:
            info = {"message": "False"} if self.simulation_running else {}
    ...
    def reward(self):
        ...
        try:
            ...
            R_total = R_safe + R_efficient + R_comfort + R_energy
